...
HD_PWD='/home/sai.divya/pkt_clone/AI_Engine_Development/Feature_Tutorials/04-packet-switching/pktstream_aie/pl_kernels/_x/hls_packet_receiver/hls_packet_receiver'
cd "$HD_PWD"
...
EAStep vitis_hls -f hls_packet_receiver.tcl -messageDb vitis_hls.pb
