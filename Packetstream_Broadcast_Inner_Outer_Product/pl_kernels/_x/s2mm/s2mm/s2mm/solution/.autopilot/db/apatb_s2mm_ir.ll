; ModuleID = '/home/sai.divya/pkt_clone/AI_Engine_Development/Feature_Tutorials/04-packet-switching/pktstream_aie/pl_kernels/_x/s2mm/s2mm/s2mm/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_s2mm_ir(%"struct.ap_uint<32>"* noalias nocapture nonnull %mem, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* noalias nocapture nonnull dereferenceable(12) %s, i32 %size) local_unnamed_addr #0 {
entry:
...
entry:
  ...
  call void @s2mm_hw_stub(%"struct.ap_uint<32>"* %6, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* %7, i32 %5)
  call void @copy_in(%"struct.ap_uint<32>"* %6, i32* %0, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* %7, i32* %1, i4* %2, i4* %3, i1* %4)
  ret void
}

declare void @s2mm_hw_stub(%"struct.ap_uint<32>"*, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"*, i32)
