...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_TVALID { I 1 bit } s_TDATA { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_TREADY { O 1 bit } s_TLAST { I 1 vector } } \
} "
} else {
...
set InstName s2mm_flow_control_loop_pipe_sequential_init_U
set CompName s2mm_flow_control_loop_pipe_sequential_init
