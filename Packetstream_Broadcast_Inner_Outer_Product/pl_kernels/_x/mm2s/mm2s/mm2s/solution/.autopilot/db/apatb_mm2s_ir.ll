; ModuleID = '/home/sai.divya/pkt_clone/AI_Engine_Development/Feature_Tutorials/04-packet-switching/pktstream_aie/pl_kernels/_x/mm2s/mm2s/mm2s/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_mm2s_ir(%"struct.ap_uint<32>"* noalias nocapture nonnull readonly %mem, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* noalias nocapture nonnull dereferenceable(12) %s, i32 %size) local_unnamed_addr #0 {
entry:
  %mem_copy = alloca i32, align 512
  %s_copy.data = alloca i32
  %s_copy.keep = alloca i4
  %s_copy.strb = alloca i4
  %s_copy.last = alloca i1
  call fastcc void @copy_in(%"struct.ap_uint<32>"* nonnull %mem, i32* nonnull align 512 %mem_copy, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* nonnull %s, i32* %s_copy.data, i4* %s_copy.keep, i4* %s_copy.strb, i1* %s_copy.last)
  call void @apatb_mm2s_hw(i32* %mem_copy, i32* %s_copy.data, i4* %s_copy.keep, i4* %s_copy.strb, i1* %s_copy.last, i32 %size)
  call void @copy_back(%"struct.ap_uint<32>"* %mem, i32* %mem_copy, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* %s, i32* %s_copy.data, i4* %s_copy.keep, i4* %s_copy.strb, i1* %s_copy.last)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"struct.ap_uint<32>"* noalias readonly "unpacked"="0", i32* noalias nocapture align 512 "unpacked"="1.0.0.0", %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* noalias "unpacked"="2", i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.3" %_V_last_V) unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<32>"(i32* align 512 %1, %"struct.ap_uint<32>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>.29"(i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i1* %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* %2)
  ret void
}
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"struct.ap_uint<32>"* noalias "unpacked"="0", i32* noalias nocapture readonly align 512 "unpacked"="1.0.0.0", %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* noalias "unpacked"="2", i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.3" %_V_last_V) unnamed_addr #4 {
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<32>.4"(%"struct.ap_uint<32>"* %0, i32* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* %2, i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i1* %_V_last_V)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<32>.4"(%"struct.ap_uint<32>"* noalias "unpacked"="0", i32* noalias nocapture readonly align 512 "unpacked"="1.0.0.0") unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<32>"(i32* noalias nocapture align 512 "unpacked"="0.0.0.0", %"struct.ap_uint<32>"* noalias readonly "unpacked"="1") unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>.29"(i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
  %1 = icmp eq %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* %0, null
  %2 = or i1 false, %1
  br i1 %2, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>.32"(i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i1* %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* nonnull %0)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>.32"(i32* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i4* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i4* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_last_V, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #3 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"struct.ap_uint<32>"* noalias "unpacked"="0", i32* noalias nocapture readonly align 512 "unpacked"="1.0.0.0", %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* noalias "unpacked"="2", i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="3.3" %_V_last_V) unnamed_addr #4 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* %2, i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i1* %_V_last_V)
  ret void
}
...
entry:
  ...
  %7 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"
  call void @copy_out(%"struct.ap_uint<32>"* %6, i32* %0, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* %7, i32* %1, i4* %2, i4* %3, i1* %4)
  call void @mm2s_hw_stub(%"struct.ap_uint<32>"* %6, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* %7, i32 %5)
  call void @copy_in(%"struct.ap_uint<32>"* %6, i32* %0, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"* %7, i32* %1, i4* %2, i4* %3, i1* %4)
  ret void
}

declare void @mm2s_hw_stub(%"struct.ap_uint<32>"*, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0>, 0>"*, i32)
